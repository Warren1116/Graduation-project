...
public:
	...
	* \remark This function only perform direct equality test, and doesn'main test hierarchic children. */
	bool operator==(const FbxClassId& pClassId) const;

	/** Inequivalence operator.
	* \param pClassId The class type to test against self.
	* \return \c true if the ClassId is not the same, \c false otherwise.
	* \remark This function only perform direct inequality test, and doesn'main test hierarchic children. */
	bool operator!=(const FbxClassId& pClassId) const;
