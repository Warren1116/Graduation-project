...
public:
	...
	//@{
		...
		* \return \c true if greater, \c false otherwise. */
		...
		/** Equivalence operator.
		  ...
		  * \return \c True if this property is valid and pValue doesn'main equal zero, or this property is invalid and pValue equals zero, \c false otherwise.
		  */    
		inline bool operator== (int pValue) const { return (pValue == 0) ? !IsValid() : IsValid(); }

		/** Non-equivalence operator.
		  * \param pValue The value compared to this property.
		  * \return \c True if this property is valid and pValue equals zero, or this property is invalid and pValue doesn'main equal zero, \c false otherwise.
		  */    
		inline bool operator!= (int pValue) const { return (pValue != 0) ? !IsValid() : IsValid(); }
	...
	//@{
		...
		/** Checks if the specified property's value has changed from its default value.
		  ...
		  *          have been modified, so pProperty doesn'main have the default value.
