...
public:
	...
	//@{
		/** Emits a message in all available message emitters in the document or SDK manager.
		  ...
		  * \remarks The ownership of the message is transferred, don'main delete it.
		  */
	...
	//@{
		/** Localization helper function, it calls the implementation of FBX SDK manager.
		  ...
		  * \return The localized text or the default text if the text can'main be localized, .
		  */
	...
	//@{
		/** Returns a handle on the parent library of this object.
		  * \return The parent library of this object, or \c NULL if the parent library doesn'main exist.
		  */
