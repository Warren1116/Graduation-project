...
public:
    ...
    // 
    /** Verify that all documents that were referred to didn'main change. 
      * \return \c true if all documents didn'main change, \c false otherwise.
...
protected:
    ...
    //! Try to reconnect dangling libraries that didn'main find their parent.
